...
df = pd.read_csv("Gestor_Adelino.csv", sep=",")
...
if AvalEquipe:
    ...
    fig_Setor = px.bar(df_MédiaSetor, x=aval, y="Nome", orientation="h", height=600, barmode='group', color_discrete_map = {"Autoavaliação":"#281BD2", "Gestor":"#764D29","Pares":"#EDEC7C", "Liderados":"#F0A652"})
